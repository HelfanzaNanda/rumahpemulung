...
$.fn.PlacePicker = function (t) {
    ...
    $(this).closest("div").hover(function(){
        ...
        var btn = $('<div class="placePickerUIButton" title="Pick location from map" style="position:absolute;z-index: 1000;"><div class="'+params.btnClass+'"><i class="fa fa-map"></i> Pick your location</div></div>');
        $(this).append(btn);
        btn.click(function(){
...
$(document).ready(function(){
    $("#pickup_country").PlacePicker({
        ...
        key:"AIzaSyAGyws7bkYHZjPto6Fe56_oK8275amqf_Y",
        center: {lat: -6.917464, lng: 107.619125},
