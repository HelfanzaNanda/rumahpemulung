...
<section id="services" class="services">
    ...
    <main id="main">
        <div class="container" data-aos="fade-up">
            @if($message = Session::get('successfully_login_google'))
                ...
                <div class="col-12">
                    <div class="row justify-content-end">
                        ...
                        <div class="col-md-3 col-xs-12">
                            <input type="text" name="cari" id="input-search" class="form-control">
                        </div>
                        <div class="col-md-1 col-xs-12">
                            <button type="button" class="btn btn-success btn-block" id="cari">CARI</button>
                        </div>
                    </div>
                    <div class=" mt-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        if (message = "{{ Session::get('nothing') }}") {
            $('#modal-completed-profile').modal('show')
        }
    })

    $(document).on('click', '#btn-go-maps', function(){
        let lat = $('#latitude').val()
        let lng = $('#longtitude').val()
