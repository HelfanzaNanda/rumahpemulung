...
<style>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="table-responsive">
           <form action="{{ route('pemulung.update',$pemulung->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ old('nameof_collector') ?? $pemulung->nameof_collector }}" name="nameof_collector" class="form-control">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Phone</label>
                                <input type="text" value="{{ old('phone_collector') ?? $pemulung->phone_collector }}" name="phone_collector" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" readonly value="{{ old('email_collector') ?? $pemulung->email_collector }}" name="email_collector" class="form-control">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Address</label>
                                <textarea name="address_collector" class="form-control" rows="2">{{ old('address_collector') ?? $pemulung->address_collector }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Photo</label>
                                <input type="file" name="photo" class="form-control" value="{{ old('photo') ?? $pemulung->photo_collector }}">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea name="address_google" id="address_google" class="form-control"  rows="2">{{ old('address_google') ?? $pemulung->address_google }}</textarea>
                    ...
                    <div class="row">
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                          ...
                          <div>
                            <input type="text" id="lat" value="{{ old('latitude') ?? $pemulung->latitude }}" name="latitude" placeholder="latitude ..." class="form-control form-control-user" readonly value="{{@$address->latitude}}">
                          </div>  
                        </div>
                      </div>
                      <div class="col-md-6 col-12">
                        <div class="form-group">
                          ...
                          <div>
                            <input type="text" id="lng" value="{{ old('longitude') ?? $pemulung->longtitude }}" name="longitude" placeholder="longitude..." class="form-control form-control-user" readonly value="{{@$address->longitude}}">
                          </div>
                        </div>
                      </div>
                    </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group mt-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{ route('pemulung.delete', $pemulung->id) }}" onclick="return confirm('apakah anda yakin?')" class="btn btn-danger btn-block">Hapus</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
