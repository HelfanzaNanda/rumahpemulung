...
<head>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBYY-wMcvr6cGuSynbDsfyABKsGzOlz9X0&libraries=places&callback=initAutocomplete"
        async defer></script>
    <script>
        ...
        <form action="" method="post">
            <div class="row">
                <div class="col-sm-6 col-xs-6">
                    <div class="form-group">
                        <input disabled="disabled" class="form-control"
                            value="<?php print isset($lat) ? $lat : ''; ?>" type="text"
                ...
                <div class="col-sm-6 col-xs-6">
                    <div class="form-group">
                        <input disabled="disabled" class="form-control"
                            value="<?php print isset($lng) ? $lng : ''; ?>" type="text"
                ...
                <div class="col-xs-8">
                    <div class="form-group">
                        <textarea class="form-control"
                            value="<?php print isset($address) ? $address : ''; ?>"
                            name="address" placeholder="Alamat" id="address" readonly
                            style="margin-left:15px;"></textarea>
                    </div>
                </div>
                <div class="col-xs-4">
                    <a href="#" result="allow" onclick="return CloseMySelf();" class="btn btn-success btn-block"
                        style="margin-left:40px;">pilih</a>
                </div>
            </div>
        </form>
    </div>
