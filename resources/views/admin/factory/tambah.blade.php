...
@section('contents')
    ...
    <div class="card shadow mb-4">
        <div class="card-header">
            <h3 class="card-title">Tambah Factory</h3>
        </div>
        <div class="card-body">
        <div class="table-responsive">
           <form action="{{ url('superadmin/factory') }}" method="post" enctype="multipart/form-data">
                @csrf
               <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nameof_factory" class="form-control">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="owner_factory" class="form-control">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            <label>Phone</label>
                            <input type="text" name="phone_factory" class="form-control">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            <label>Email</label>
                            <input type="text" name="email_factory" class="form-control">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            <label>Address</label>
                            <textarea name="address_factory" class="form-control" rows="2"></textarea>
