...
@section('content')
				...
				<div class="carousel-inner" role="listbox">
					<div class="carousel-item active" style="background-image: url(assets/img/hero-bg.jpg)">
						<div class="carousel-container">
							<div class="container">
								<h2 class="animate__animated animate__fadeInDown">Rumah Pemulung</h2>
								<p class="animate__animated animate__fadeInUp">Sampah Jadi Duit, Sampah Jadi Berkat</p>
								<a href="#about" class="btn-get-started scrollto animate__animated animate__fadeInUp">Get Started</a>
							</div>
						</div>
					</div>

					<div class="carousel-item" style="background-image: url(assets/img/hero-bg3.jpg)">
						<div class="carousel-container">
							<div class="container">
								<h2 class="animate__animated animate__fadeInDown">Rumah Pemulung</h2>
								<p class="animate__animated animate__fadeInUp">Sampah Jadi Duit, Sampah Jadi Berkat</p>
	...
	<main id="main">
						...
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<div class="portfolio-links">
									<a href="{{ asset('assets/img/types/pet.jpg') }}" data-gall="portfolioGallery" class="venobox"
										title="PET"><i class="bx bx-plus" width="100%"></i></a>
									<a href="/pet" data-gall="portfolioDetailsGallery" data-vbtype="iframe"
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-hdpe">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<div class="portfolio-links">
									<a href="{{ asset('assets/img/types/hdpe.jpg') }}" data-gall="portfolioGallery" class="venobox"
										title="HDPE"><i class="bx bx-plus" width="100%"></i></a>
									<a href="/hdpe" data-gall="portfolioDetailsGallery" data-vbtype="iframe"
										class="venobox" title="Portfolio Details"><i class="bx bx-link"></i></a>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-pet">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<div class="portfolio-links">
									<a href="{{ asset('assets/img/types/pvc.jpg') }}" data-gall="portfolioGallery" class="venobox"
										title="PVC"><i class="bx bx-plus" width="100%"></i></a>
									<a href="/pvc" data-gall="portfolioDetailsGallery" data-vbtype="iframe"
										class="venobox" title="Portfolio Details"><i class="bx bx-link"></i></a>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-pvc">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<div class="portfolio-links">
									<a href="{{ asset('assets/img/types/ldpe.jpg') }}" data-gall="portfolioGallery" class="venobox"
										title="LDPE"><i class="bx bx-plus" width="100%"></i></a>
									<a href="/ldpe" data-gall="portfolioDetailsGallery" data-vbtype="iframe"
										class="venobox" title="Portfolio Details"><i class="bx bx-link"></i></a>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-hdpe">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<p>Polypropylene</p>
								<div class="portfolio-links">
									<a href="{{ asset('assets/img/types/pp.jpg') }}" data-gall="portfolioGallery" class="venobox"
										title="PP"><i class="bx bx-plus" width="100%"></i></a>
									<a href="/pp" data-gall="portfolioDetailsGallery" data-vbtype="iframe"
										class="venobox" title="Portfolio Details"><i class="bx bx-link"></i></a>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-pet">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<p>Polystyrene</p>
								<div class="portfolio-links">
									<a href="{{ asset('assets/img/types/ps.jpg') }}" data-gall="portfolioGallery" class="venobox"
										title="PS"><i class="bx bx-plus" width="100%"></i></a>
									<a href="/ps" data-gall="portfolioDetailsGallery" data-vbtype="iframe"
										class="venobox" title="Portfolio Details"><i class="bx bx-link"></i></a>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-md-6 portfolio-item filter-pet">
						<div class="portfolio-wrap">
							...
							<div class="portfolio-info">
								...
								<div class="portfolio-links">
									<a href="{{ asset('assets/img/types/other.jpg') }}" data-gall="portfolioGallery" class="venobox"
										title="Others"><i class="bx bx-plus" width="100%"></i></a>
					...
					<div class="col-lg-8 pt-4 pt-lg-0 content">
						<div class="row">
							<div class="col-lg-6">
								<ul>
									<li><h3>Vision</h3></li>
									<li><p class="icofont-rounded-right">Change trash to become surplus</p></li>
								</ul>
							</div>
							...
							<div class="col-lg-6">
								<ul>
									<li><h3>Mission</h3></li>
									<li><p class="icofont-rounded-right">Generating people to collecting the waste</p></li>
									<li><p class="icofont-rounded-right">Making value of waste</p></li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-8 text-center">
						<h2 class="text-md-2 text-black">Sell The Waste</h2>
						<h2 class="mt-3 text-green mb-4">Jual & Jadilah Agent Peduli Lingkungan</h2>
						<span class="font-extra text-md-2 text-black-70">Sampah Yang Anda Jual Membantu Banyak
							Orang</span>
					</div>
				</div>
			</div>
		...
		<!--App start -->
		<section class="section download about-area area-padding">
			<div class="container">
				<div class="row ">
					<div class="col-sm-18 col-lg-10 col-md-12 col-18">
						<div class="row align-items-center">
							<div class="col-16 col-sm-16 col-lg-6 col-md-6">
								<img src="{{ asset('assets/img/phone.PNG') }}" alt="" class="img-fluid" width="75%">
							</div>

							<div class="col-16 col-sm-16 col-lg-6 col-md-6">
								<span class="text-primary font-md font-extra">Make it easy</span>
								<h2 class="mt-3">Get the Rumah Pemulung App</h2>
								<p class="mt-4">Sell your waste instantly right in your pocket. </p>
		...
		<section id="contact" class="contact">
			...
			<div data-aos="fade-up" class="text-center">
				<iframe style="border:0; width: 82%; height: 300px;"
					src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1980.348076882581!2d107.72779475420178!3d-6.926876254052113!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68c332eb805039%3A0xdda2e6102325458d!2sKomplek%20Cibiru%20Asri%202!5e0!3m2!1sid!2sid!4v1599814194985!5m2!1sid!2sid"
					...
					<div class="col-lg-4">
						<div class="info">
							<div class="address">
								...
								<h4>Location:</h4>
								<p>Komp. Cibiru Asri blok S/1, 3rd floor, Cibiru Wetan,
							...
							<div class="email">
								...
								<h4>Email:</h4>
								<p>rumahpemulung@gmail.com</p>
							</div>

							<div class="phone">
								<i class="icofont-phone"></i>
								<h4>Call:</h4>
								<p>(+62)818-0945-6734</p>
							</div>
