...
@section('contents')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="table-responsive">
           <form action="{{ url('lapak/pemulung') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="nameof_collector" class="form-control">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Phone</label>
                                <input type="text" name="phone_collector" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" name="email_collector" class="form-control">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group">
                                <label>Address</label>
                                <textarea name="address_collector" class="form-control" rows="2"></textarea>
