            ...
            <div class="col-md-12">
                                        ...
                                        <div class="card-body">
                                            <div class="col"
                                                ...
                                                <div class="form-group text-center">
                                                    <img src="{{ url('assets/img/sales/'.$x->cphoto1) }}" width="100px" alt="">
                                                </div>
                                            </div>
                                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-12 mt-2">
                                    ...
                                    <div class="card-body">
                                        <div class="col"
                                            style="border: 5px solid black">
                                            <div class="form-group text-center">
                                                <img src="{{ url('assets/img/sales/'.$x->cpoto2) }}" width="100px" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-xs-12">
                                            <table style="width:100%">
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="col"
                                                style="border: 5px solid black">
                                                <div class="form-group text-center">
                                                    <img src="{{ url('assets/img/sales/'.$x->cpoto3) }}" width="100px" alt="">
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-xs-12">
                                                <table style="width:100%">
                ...
                <div class="col">
                    ...
                    <div class="submit-button text-right">
                        <button type="submit" class="btn btn-md btn-common">Pickup</button>
                    </div>
                </div>
            </form>
        </div>
