...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    @elseif(Auth::guard('lapak')->check())
        ...
        <li class="nav-item">
            ...
            <div id="collapseThre" class="collapse" aria-labelledby="headingThre" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{ url('lapak/sales') }}">Sales Order</a>
                    <a class="collapse-item" href="{{ url('lapak/sales') }}">Goods Issue</a>
                    <a class="collapse-item" href="{{ url('lapak/sales') }}">Invoice</a>
               </div>
            </div>            
        </li>
