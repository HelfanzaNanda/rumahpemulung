        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 photo">
                    <img src="{{ url('images/'.Auth::guard('client')->user()->photo) }}"><br>
                </div>

                <div class="col-md-7">
                    <h2>{{ Auth::guard('client')->user()->username }}</h2>
                    <p>{{ Auth::guard('client')->user()->email_client }}</p>
                    <p>{{ Auth::guard('client')->user()->phone_client }}</p>
                </div>

                <!--div class="col-md-3">
                    <div class="row">
                    <div class="col">
                        <a href="{{ url('client/edit') }}" method="get">
                            <i><img src="{{ url('assets/img/profile/edit.png') }}" width="50%">
                            <br></i>Edit Profil</a>
                    </div>
                    <div class="col">
                        <a href="{{ url('client/sales') }}" method="get">
